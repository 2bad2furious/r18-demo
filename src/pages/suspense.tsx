...
/**
 * TODO
 * - explore SuspensePage, SomeData components
 * - add error boundary to display errors
 * - share suspense boundary for multiple/nested components
...
export const SuspensePage = () => {
    return <>
        ...
        <Suspense fallback={<Loader/>}>
            <SomeData timeout={1500} queryKey="a"/>
        </Suspense>
    </>
}
